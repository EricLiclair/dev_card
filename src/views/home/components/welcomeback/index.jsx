...
export default function HomeWelcomeBack() {
    ...
    return (
        <Box sx={{ width: '100%', maxWidth: 500 }} textAlign='justify'>
            ...
            <Typography variant='h3' component='div' gutterBottom>Welcome Back!</Typography>
            <br />
            <Typography variant='h5' component='div' gutterBottom>What's your plan today?</Typography>
            <Typography variant='body1' component='div' gutterBottom>You can solve problems from a curated list of questions. Or, you can revise your previously solved questions to never forget.</Typography>
            ...
            <Box display='flex' justifyContent='space-around'>
                <Tooltip title='solve more questions from a curated list'>
                    <Button href='/dashboard' variant='contained' color='secondary'>Solve more</Button>
                </Tooltip>
